...
// adapted: fallback backgroundColor changed from the template's paper tone
// (#faf7f2) to this project's own --cream token (#f2ede2) so the letterboxed
// edges match the surrounding shot background exactly (no visible seam).
...
export const PageCam: React.FC<{
  ...
  if (!has3D) {
    return (
      <AbsoluteFill style={{ overflow: 'hidden', backgroundColor: '#f2ede2' }}>
        <div
          style={{
