...
// close, tail fade. Copy replaced with the real USP from the Leistungen
// section's service-row--featured ("Alleinstellungsmerkmal"); digit-roll
// stat subtitle dropped (no comparable stat on the real page to cite).
  ...
  return (
    ...
    >
      <div style={{ textAlign: 'center', maxWidth: 1500 }}>
        <div style={{ fontFamily: FONT_DISPLAY, fontSize: 92, fontWeight: 500, lineHeight: 1.2, color: INK, letterSpacing: '-0.01em', display: 'flex', flexWrap: 'wrap', justifyContent: 'center', columnGap: '0.28em' }}>
          {WORDS.map((w, i) => {
            const delay = 4 + i * 4;
